...
<div
	id="navMobile"
	class="fixed w-0 h-full z-50 overflow-x-hidden bg-gray-800 bg-opacity-95">
	<div class="flex flex-wrap flex-col content-end px-6 my-4">
		<button class="flex-1 p-0 text-white text-5xl" on:click={closeNav}>
			×
		</button>
	</div>
