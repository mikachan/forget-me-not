...
var import_index_ff5e144f = require("./index-ff5e144f.js");
...
const Waypoint = (0, import_index_ff5e144f.c)(($$result, $$props, $$bindings, slots) => {
  (0, import_index_ff5e144f.j)();
  let { offset = 0 } = $$props;
  ...
  return `<div class="${"wrapper " + (0, import_index_ff5e144f.e)(className) + " " + (0, import_index_ff5e144f.e)(c) + " svelte-pj5vj2"}"${(0, import_index_ff5e144f.b)("style", style, 0)}>${visible ? `${slots.default ? slots.default({}) : ``}` : ``}</div>`;
});
...
const Image = (0, import_index_ff5e144f.c)(($$result, $$props, $$bindings, slots) => {
  let { c = "" } = $$props;
  let { alt = "" } = $$props;
  ...
  if ($$props.class === void 0 && $$bindings.class && className !== void 0)
    $$bindings.class(className);
  $$result.css.add(css);
  return `${(0, import_index_ff5e144f.v)(Waypoint, "Waypoint").$$render($$result, {
    class: wrapperClass,
    ...
    default: () => {
      return `<div style="${"position: relative; width: 100%;"}" class="${["svelte-uco8jw", loaded ? "loaded" : ""].join(" ").trim()}"><div style="${"position: relative; overflow: hidden;"}"><div style="${"width:100%;padding-bottom:" + (0, import_index_ff5e144f.e)(ratio) + ";"}"></div>
      ${blurhash ? `<canvas class="${"placeholder svelte-uco8jw"}"${(0, import_index_ff5e144f.b)("width", blurhashSize.width, 0)}${(0, import_index_ff5e144f.b)("height", blurhashSize.height, 0)}></canvas>` : `<img class="${[
        "placeholder " + (0, import_index_ff5e144f.e)(placeholderClass) + " svelte-uco8jw",
        blur ? "blur" : ""
      ].join(" ").trim()}"${(0, import_index_ff5e144f.b)("src", src, 0)}${(0, import_index_ff5e144f.b)("alt", alt, 0)}>`}
      <picture><source type="${"image/webp"}"${(0, import_index_ff5e144f.b)("srcset", srcsetWebp, 0)}${(0, import_index_ff5e144f.b)("sizes", sizes, 0)}>
        <source${(0, import_index_ff5e144f.b)("srcset", srcset, 0)}${(0, import_index_ff5e144f.b)("sizes", sizes, 0)}>
        <img${(0, import_index_ff5e144f.b)("src", src, 0)} class="${"main " + (0, import_index_ff5e144f.e)(c) + " " + (0, import_index_ff5e144f.e)(className) + " svelte-uco8jw"}"${(0, import_index_ff5e144f.b)("alt", alt, 0)}${(0, import_index_ff5e144f.b)("width", width, 0)}${(0, import_index_ff5e144f.b)("height", height, 0)}></picture></div></div>`;
    }
  })}`;
});
