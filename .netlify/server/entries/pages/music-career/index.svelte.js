...
const Music_career = (0, import_index_db852415.c)(($$result, $$props, $$bindings, slots) => {
...
<p>Luscious is a Japanese band formed by ${(0, import_index_db852415.v)(import_Link_a57e5296.L, "Link").$$render($$result, {
    href: "https://twitter.com/CHACHAMARU_YFCz"
  }, {}, {
    default: () => {
      return `Chachamaru (Yukihiro Fujimura)`;
    }
  })}, and includes Chacha on vocals and guitar, You on guitar, ${(0, import_index_db852415.v)(import_Link_a57e5296.L, "Link").$$render($$result, {
    href: "https://twitter.com/Satos_Cafe_Bar"
  }, {}, {
    default: () => {
      return `Sato`;
    }
  })} (ex. GacktJob, LiSA) on bass and ${(0, import_index_db852415.v)(import_Link_a57e5296.L, "Link").$$render($$result, {
...
<p>Chacha posts about Luscious on his Twitter account and often streams on ${(0, import_index_db852415.v)(import_Link_a57e5296.L, "Link").$$render($$result, {
