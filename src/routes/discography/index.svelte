...
<style>
	...
	.table-scroll {
		@apply w-full overflow-x-auto pr-20;
	}

	.table-fade {
		@apply absolute top-0 bottom-0 right-0 z-50 w-20 bg-gradient-to-r from-transparent to-white md:hidden;
	}
...
<h3>Visual Appearances <a href="discography/appearances" class="text-sm">read more&nbsp;&rarr;</a></h3>

<p>You has appeared in many videos, books and magazines, especially from working with Gackt. The highlight obviously being his acting skillz in <em>Moon Child</em>:</p>
