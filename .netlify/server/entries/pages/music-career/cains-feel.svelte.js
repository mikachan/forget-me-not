...
const Cains_feel = (0, import_index_430bc4f2.c)(($$result, $$props, $$bindings, slots) => {
...
<figure style="${"width: 140px;"}">${(0, import_index_430bc4f2.v)(import_Image_097dc189.I, "Image").$$render($$result, {
...
<ol class="${"list-decimal list-inside"}"><li>\uFF5Elie\uFF5E [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, { href: "https://youtu.be/cVe9rssPA84" }, {}, { default: () => `youtube` })}]</li>
	<li>MARINE BLUE no kazeni dakarete (marine blue\u306E\u98A8\u306B\u62B1\u304B\u308C\u3066) [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, { href: "https://youtu.be/A6CEeoU1KG4" }, {}, { default: () => `youtube` })}]</li>
	<li>etude [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, { href: "https://youtu.be/cvGPKVu3LPQ" }, {}, { default: () => `youtube` })}] [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, {
...
<ol class="${"list-decimal list-inside"}"><li>refrain</li>
	<li>\uFF5Elie\uFF5E [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, { href: "https://youtu.be/cVe9rssPA84" }, {}, { default: () => `youtube` })}]</li>
	<li>MARINE BLUE no kazeni dakarete (marine blue\u306E\u98A8\u306B\u62B1\u304B\u308C\u3066) [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, { href: "https://youtu.be/A6CEeoU1KG4" }, {}, { default: () => `youtube` })}]</li>
	<li>etude [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, { href: "https://youtu.be/cvGPKVu3LPQ" }, {}, { default: () => `youtube` })}] [${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, {
    href: "downloads/etude.txt",
    download: "etude lyric translation"
