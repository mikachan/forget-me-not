...
const getStores = () => {
  const stores = (0, import_index_430bc4f2.g)("__svelte__");
  return {
    page: {
...
const gaStore = (0, import_index_365aa037.w)([]);
function test() {
...
const GoogleAnalytics = (0, import_index_430bc4f2.c)(($$result, $$props, $$bindings, slots) => {
...
const NavContent = (0, import_index_430bc4f2.c)(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = (0, import_index_430bc4f2.a)(page, (value) => $page = value);
  $$result.css.add(css$1);
  $$unsubscribe_page();
  return `<nav><ul class="${"svelte-1jphw99"}"><li class="${"svelte-1jphw99"}"><a${(0, import_index_430bc4f2.b)("aria-current", $page.url.pathname === "/" ? "page" : void 0, 0)} href="${"."}" class="${["svelte-1jphw99", $page.url.pathname == "/" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Home</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_430bc4f2.b)("aria-current", $page.url.pathname === "/about-you" ? "page" : void 0, 0)} href="${"/about-you"}" class="${["svelte-1jphw99", $page.url.pathname == "/about-you" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">About YOU</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_430bc4f2.b)("aria-current", $page.url.pathname === "/music-career" ? "page" : void 0, 0)} href="${"/music-career"}" class="${["svelte-1jphw99", $page.url.pathname == "/music-career" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Music Career</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_430bc4f2.b)("aria-current", $page.url.pathname === "/discography" ? "page" : void 0, 0)} href="${"/discography"}" class="${["svelte-1jphw99", $page.url.pathname == "/discography" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Discography</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_430bc4f2.b)("aria-current", $page.url.pathname === "/where-to-buy" ? "page" : void 0, 0)} href="${"/where-to-buy"}" class="${["svelte-1jphw99", $page.url.pathname == "/where-to-buy" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Where to Buy</span></a></li></ul></nav>`;
});
const Nav = (0, import_index_430bc4f2.c)(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"hidden lg:block lg:w-3/5 relative top-20"}">${(0, import_index_430bc4f2.v)(NavContent, "NavContent").$$render($$result, {}, {}, {})}</div>
...
const NavMobile = (0, import_index_430bc4f2.c)(($$result, $$props, $$bindings, slots) => {
  return `<div id="${"navMobile"}" class="${"fixed w-0 h-full z-50 overflow-x-hidden bg-gray-800 bg-opacity-95"}"><div class="${"flex flex-wrap flex-col content-end px-6 my-4"}"><button class="${"flex-1 p-0 text-white text-5xl"}">\xD7</button></div>
    ...
    <div class="${"overlay-content mt-6 px-6"}">${(0, import_index_430bc4f2.v)(NavContent, "NavContent").$$render($$result, {}, {}, {})}</div></div>`;
});
var tailwindOutput = "";
var app = "";
...
const _layout = (0, import_index_430bc4f2.c)(($$result, $$props, $$bindings, slots) => {
  let mainImage = you01;
  ...
  $$result.css.add(css);
  return `${`${(0, import_index_430bc4f2.v)(GoogleAnalytics, "GoogleAnalytics").$$render($$result, { properties: ["G-WN3BJ9W3N5"] }, {}, {})}`}

${(0, import_index_430bc4f2.v)(NavMobile, "NavMobile").$$render($$result, {}, {}, {})}

<div class="${"font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover"}" style="${"background-image:url(" + (0, import_index_430bc4f2.e)(bg) + ");"}"><div class="${"max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto py-32 px-6 lg:px-0 lg:my-0"}">${(0, import_index_430bc4f2.v)(Nav, "Nav").$$render($$result, {}, {}, {})}

		<div class="${"main-content w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 lg:mx-0 lg:h-4/6 lg:overflow-y-scroll"}"><div class="${"p-4 md:p-6"}"><div class="${"block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-top"}" style="${"background-image: url(" + (0, import_index_430bc4f2.e)(mainImage) + ")"}"></div>
				...
				<div class="${"pt-4"}"><p class="${"italic text-xs text-center lg:text-left"}">\xA9 2004-2021<br>
						${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, {
    href: "https://sekai.co.uk",
    class: "no-underline"
  }, {}, { default: () => `Contact webmaster` })} \u2022 ${(0, import_index_430bc4f2.v)(import_Link_0d4e9abf.L, "Link").$$render($$result, {
    href: "https://github.com/mikachan/forget-me-not",
    class: "no-underline"
  }, {}, { default: () => `View on GitHub` })}</p></div></div></div>

		<div class="${"image-rotation w-full lg:w-2/5 svelte-1pidex7"}"><figure class="${"hidden lg:block svelte-1pidex7"}">${(0, import_index_430bc4f2.v)(import_Image_097dc189.I, "Image").$$render($$result, {
    src: mainImage,
    alt: "You",
