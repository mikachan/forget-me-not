...
const NavContent = (0, import_index_9861661c.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<nav><ul class="${"svelte-1jphw99"}"><li class="${"svelte-1jphw99"}"><a${(0, import_index_9861661c.b)("aria-current", $page.url.pathname === "/" ? "page" : void 0, 0)} href="${"."}" class="${["svelte-1jphw99", $page.url.pathname == "/" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Home</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_9861661c.b)("aria-current", $page.url.pathname === "/about-you" ? "page" : void 0, 0)} href="${"/about-you"}" class="${["svelte-1jphw99", $page.url.pathname == "/about-you" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">About YOU</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_9861661c.b)("aria-current", $page.url.pathname === "/music-career" ? "page" : void 0, 0)} href="${"/music-career"}" class="${["svelte-1jphw99", $page.url.pathname == "/music-career" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Music Career</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_9861661c.b)("aria-current", $page.url.pathname === "/discography" ? "page" : void 0, 0)} href="${"/discography"}" class="${["svelte-1jphw99", $page.url.pathname == "/discography" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Discography</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${(0, import_index_9861661c.b)("aria-current", $page.url.pathname === "/where-to-buy" ? "page" : void 0, 0)} href="${"/where-to-buy"}" class="${["svelte-1jphw99", $page.url.pathname == "/where-to-buy" ? "active" : ""].join(" ").trim()}"><span class="${"svelte-1jphw99"}">Where to Buy</span></a></li></ul></nav>`;
});
