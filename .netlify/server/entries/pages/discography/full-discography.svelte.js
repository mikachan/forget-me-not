...
const Full_discography = (0, import_index_430bc4f2.c)(($$result, $$props, $$bindings, slots) => {
...
<div class="${"table-container svelte-14x1pov"}"><div class="${"table-fade svelte-14x1pov"}"${(0, import_index_430bc4f2.b)("this", albumsFade, 0)}></div>
	<div class="${"table-scroll svelte-14x1pov"}"${(0, import_index_430bc4f2.b)("this", albumsTable, 0)}><table class="${"svelte-14x1pov"}"><thead><tr><th class="${"svelte-14x1pov"}">Year</th>
...
<div class="${"table-container svelte-14x1pov"}"><div class="${"table-fade svelte-14x1pov"}"${(0, import_index_430bc4f2.b)("this", singlesFade, 0)}></div>
	<div class="${"table-scroll svelte-14x1pov"}"${(0, import_index_430bc4f2.b)("this", singlesTable, 0)}><table class="${"svelte-14x1pov"}"><thead><tr><th class="${"svelte-14x1pov"}">Year</th>
					<th class="${"svelte-14x1pov"}">Title</th>
					<th class="${"svelte-14x1pov"}">Artist</th>
					<th class="${"svelte-14x1pov"}">Credits</th></tr></thead>
			<tbody><tr><td class="${"svelte-14x1pov"}">1994</td>
...
<div class="${"table-container svelte-14x1pov"}"><div class="${"table-fade svelte-14x1pov"}"${(0, import_index_430bc4f2.b)("this", dvdsFade, 0)}></div>
	<div class="${"table-scroll svelte-14x1pov"}"${(0, import_index_430bc4f2.b)("this", dvdsTable, 0)}><table class="${"svelte-14x1pov"}"><thead><tr><th class="${"svelte-14x1pov"}">Year</th>
					<th class="${"svelte-14x1pov"}">Title</th>
					<th class="${"svelte-14x1pov"}">Artist</th>
					<th class="${"svelte-14x1pov"}">Credits</th></tr></thead>
