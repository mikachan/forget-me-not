...
const cake = "/_app/immutable/assets/bdaycake-cc22d69f.jpg";
...
<p>The cake that You received is shown below (snagged it off the ${validate_component(Link, "Link").$$render(
    $$result,
    {
