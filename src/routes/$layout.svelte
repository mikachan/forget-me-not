...
<div
	class="font-sans antialiased text-gray-900 leading-normal tracking-wider
	bg-cover"
	style="background-image:url({bg});">
	<div
		class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto
		py-32 px-6 lg:px-0 lg:my-0">

		<Nav {segment} />

		<div
			class="main-content w-full lg:w-3/5 rounded-lg lg:rounded-l-lg
			lg:rounded-r-none shadow-2xl bg-white opacity-75 lg:mx-0 lg:h-4/6
			lg:overflow-y-scroll">
			<div class="p-4 md:p-6">
				<div
					class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16
					h-48 w-48 bg-cover bg-top"
					style="background-image: url({mainImage})" />

				<h1
					class="text-3xl font-bold pt-8 lg:pt-0 text-center
					lg:text-left">
					Forget-me-not: a You fansite
				</h1>
				<div
					class="mx-auto lg:mx-0 w-4/5 my-3 border-b-2
					border-green-500 opacity-25" />
				...
				<div class="pt-4">
					<p class="italic text-xs text-center lg:text-left">
						&copy; 2004-2021
						<br />
						<Link href="https://sekai.co.uk" class="no-underline">
							Contact webmaster
						</Link>
						&bullet;
						<Link
