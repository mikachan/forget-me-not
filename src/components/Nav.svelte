...
<div class="block lg:hidden">
	<button class="fixed top-6 right-6 z-40 px-3 py-2 border rounded text-gray-200 bg-gray-800 border-gray-400 hover:text-gray-300 hover:border-gray-600" on:click={openNav}>
