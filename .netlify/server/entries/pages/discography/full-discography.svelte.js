...
const Full_discography = (0, import_index_8b43e98c.c)(($$result, $$props, $$bindings, slots) => {
...
<div class="${"table-container svelte-4rpisw"}"><div class="${"table-fade svelte-4rpisw"}"${(0, import_index_8b43e98c.b)("this", albumsFade, 0)}></div>
	<div class="${"table-scroll svelte-4rpisw"}"${(0, import_index_8b43e98c.b)("this", albumsTable, 0)}><table class="${"svelte-4rpisw"}"><thead><tr><th class="${"svelte-4rpisw"}">Year</th>
...
<div class="${"table-container svelte-4rpisw"}"><div class="${"table-fade svelte-4rpisw"}"${(0, import_index_8b43e98c.b)("this", singlesFade, 0)}></div>
	<div class="${"table-scroll svelte-4rpisw"}"${(0, import_index_8b43e98c.b)("this", singlesTable, 0)}><table class="${"svelte-4rpisw"}"><thead><tr><th class="${"svelte-4rpisw"}">Year</th>
					<th class="${"svelte-4rpisw"}">Title</th>
					<th class="${"svelte-4rpisw"}">Artist</th>
					<th class="${"svelte-4rpisw"}">Credits</th></tr></thead>
			<tbody><tr><td class="${"svelte-4rpisw"}">1994</td>
...
<div class="${"table-container svelte-4rpisw"}"><div class="${"table-fade svelte-4rpisw"}"${(0, import_index_8b43e98c.b)("this", dvdsFade, 0)}></div>
	<div class="${"table-scroll svelte-4rpisw"}"${(0, import_index_8b43e98c.b)("this", dvdsTable, 0)}><table class="${"svelte-4rpisw"}"><thead><tr><th class="${"svelte-4rpisw"}">Year</th>
					<th class="${"svelte-4rpisw"}">Title</th>
					<th class="${"svelte-4rpisw"}">Artist</th>
					<th class="${"svelte-4rpisw"}">Credits</th></tr></thead>
