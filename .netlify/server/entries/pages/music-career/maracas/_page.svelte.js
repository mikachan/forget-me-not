...
<p>Gackt described the cover band he put together in the Malice Mizer fanclub magazine <em>Ma chérie</em> (vol. 2&amp;3). He first called ${validate_component(Link, "Link").$$render(
    $$result,
    {
