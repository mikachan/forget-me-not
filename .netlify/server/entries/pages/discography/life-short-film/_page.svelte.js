...
<p>Gackt has mentioned in interviews that the concept for the video was inspired by the German film, ${validate_component(Link, "Link").$$render(
    $$result,
    {
...
<h3>Download</h3>
<p><em>Soyokaze</em> seems pretty difficult to get hold of these days, so I&#39;ve uploaded <em>Life</em> ${validate_component(Link, "Link").$$render(
    $$result,
    {
...
<p>Translation by <strong>muchuu</strong>, originally on myspace and later found ${validate_component(Link, "Link").$$render(
    $$result,
    {
