...
function init(settings = default_settings) {
  ...
  options = {
    ...
    entry: {
      ...
      css: [assets + "/_app/assets/start-c446e5f0.css", assets + "/_app/assets/vendor-53181f56.css"],
      js: [assets + "/_app/start-26e9105d.js", assets + "/_app/chunks/vendor-5317cca6.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/music-career/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/music-career/birthday-2003.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/music-career/cains-feel.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/music-career/you-gackt.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/music-career/gacktjob.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/music-career/maracas.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/music-career/sqf.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
    ...
    },
    {
      ...
      pattern: /^\/discography\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/discography/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/discography/full-discography.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/discography/life-short-film.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/discography/nine-nine-radio.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/discography/appearances.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/about-you\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/about-you/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/about-you/designs.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/music-career/index.svelte": () => Promise.resolve().then(function() {
    return index$3;
  }),
  "src/routes/music-career/birthday-2003.svelte": () => Promise.resolve().then(function() {
    return birthday2003;
  }),
  "src/routes/music-career/cains-feel.svelte": () => Promise.resolve().then(function() {
    return cainsFeel;
  }),
  "src/routes/music-career/you-gackt.svelte": () => Promise.resolve().then(function() {
    return youGackt;
  }),
  "src/routes/music-career/gacktjob.svelte": () => Promise.resolve().then(function() {
    return gacktjob;
  }),
  "src/routes/music-career/maracas.svelte": () => Promise.resolve().then(function() {
    return maracas;
  }),
  "src/routes/music-career/sqf.svelte": () => Promise.resolve().then(function() {
    return sqf;
  }),
  "src/routes/where-to-buy.svelte": () => Promise.resolve().then(function() {
    return whereToBuy;
  }),
  "src/routes/discography/index.svelte": () => Promise.resolve().then(function() {
    return index$2;
  }),
  "src/routes/discography/full-discography.svelte": () => Promise.resolve().then(function() {
    return fullDiscography;
  }),
  "src/routes/discography/life-short-film.svelte": () => Promise.resolve().then(function() {
    return lifeShortFilm;
  }),
  "src/routes/discography/nine-nine-radio.svelte": () => Promise.resolve().then(function() {
    return nineNineRadio;
  }),
  "src/routes/discography/appearances.svelte": () => Promise.resolve().then(function() {
    return appearances;
  }),
  "src/routes/about-you/index.svelte": () => Promise.resolve().then(function() {
    return index$1;
  }),
  "src/routes/about-you/designs.svelte": () => Promise.resolve().then(function() {
    return designs;
  }),
  ...
  "src/routes/site/history.svelte": () => Promise.resolve().then(function() {
    return history;
  }),
  "src/routes/site/updates.svelte": () => Promise.resolve().then(function() {
    return updates;
  }),
  "src/routes/site/thanks.svelte": () => Promise.resolve().then(function() {
    return thanks;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-0dd6e1c6.js", "css": ["assets/pages/__layout.svelte-6566748f.css", "assets/vendor-53181f56.css"], "js": ["pages/__layout.svelte-0dd6e1c6.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-f4fa9ded.js", "css": ["assets/vendor-53181f56.css"], "js": ["error.svelte-f4fa9ded.js", "chunks/vendor-5317cca6.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-e854cf6a.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/index.svelte-e854cf6a.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js"], "styles": [] }, "src/routes/music-career/index.svelte": { "entry": "pages/music-career/index.svelte-70bd60ae.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/music-career/index.svelte-70bd60ae.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/1996-mm-a4a68d6c.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/music-career/birthday-2003.svelte": { "entry": "pages/music-career/birthday-2003.svelte-75b9843f.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/music-career/birthday-2003.svelte-75b9843f.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/music-career/cains-feel.svelte": { "entry": "pages/music-career/cains-feel.svelte-d24a4648.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/music-career/cains-feel.svelte-d24a4648.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/music-career/you-gackt.svelte": { "entry": "pages/music-career/you-gackt.svelte-8325ac17.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/music-career/you-gackt.svelte-8325ac17.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/music-career/gacktjob.svelte": { "entry": "pages/music-career/gacktjob.svelte-255ec256.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/music-career/gacktjob.svelte-255ec256.js", "chunks/vendor-5317cca6.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/music-career/maracas.svelte": { "entry": "pages/music-career/maracas.svelte-6b86f66c.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/music-career/maracas.svelte-6b86f66c.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/1996-mm-a4a68d6c.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/music-career/sqf.svelte": { "entry": "pages/music-career/sqf.svelte-2b1be53b.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/music-career/sqf.svelte-2b1be53b.js", "chunks/vendor-5317cca6.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/where-to-buy.svelte": { "entry": "pages/where-to-buy.svelte-49d726b9.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/where-to-buy.svelte-49d726b9.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/discography/index.svelte": { "entry": "pages/discography/index.svelte-03cc0aa4.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/discography/index.svelte-03cc0aa4.js", "chunks/vendor-5317cca6.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/discography/full-discography.svelte": { "entry": "pages/discography/full-discography.svelte-dbe170f1.js", "css": ["assets/pages/discography/full-discography.svelte-55e11db3.css", "assets/vendor-53181f56.css"], "js": ["pages/discography/full-discography.svelte-dbe170f1.js", "chunks/vendor-5317cca6.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/discography/life-short-film.svelte": { "entry": "pages/discography/life-short-film.svelte-f292fcdc.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/discography/life-short-film.svelte-f292fcdc.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/discography/nine-nine-radio.svelte": { "entry": "pages/discography/nine-nine-radio.svelte-e937edd3.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/discography/nine-nine-radio.svelte-e937edd3.js", "chunks/vendor-5317cca6.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/discography/appearances.svelte": { "entry": "pages/discography/appearances.svelte-f9817c47.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/discography/appearances.svelte-f9817c47.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/about-you/index.svelte": { "entry": "pages/about-you/index.svelte-65da6320.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/about-you/index.svelte-65da6320.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/about-you/designs.svelte": { "entry": "pages/about-you/designs.svelte-63e6e92e.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/about-you/designs.svelte-63e6e92e.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-4509e062.js", "css": ["assets/pages/about.svelte-91e1140c.css", "assets/vendor-53181f56.css"], "js": ["pages/about.svelte-4509e062.js", "chunks/vendor-5317cca6.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-4798bf2f.js", "css": ["assets/pages/todos/index.svelte-6d5ca49c.css", "assets/vendor-53181f56.css"], "js": ["pages/todos/index.svelte-4798bf2f.js", "chunks/vendor-5317cca6.js"], "styles": [] }, "src/routes/site/history.svelte": { "entry": "pages/site/history.svelte-1d5b6d1a.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/site/history.svelte-1d5b6d1a.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/site/updates.svelte": { "entry": "pages/site/updates.svelte-2f295fb1.js", "css": ["assets/pages/site/updates.svelte-b9244357.css", "assets/vendor-53181f56.css"], "js": ["pages/site/updates.svelte-2f295fb1.js", "chunks/vendor-5317cca6.js", "chunks/Link-89bf6b11.js", "chunks/store-14313536.js"], "styles": [] }, "src/routes/site/thanks.svelte": { "entry": "pages/site/thanks.svelte-186f18d7.js", "css": ["assets/vendor-53181f56.css"], "js": ["pages/site/thanks.svelte-186f18d7.js", "chunks/vendor-5317cca6.js", "chunks/store-14313536.js"], "styles": [] } };
...
function loader(urls, test2, callback) {
  ...
  if (!test2()) {
    urls.forEach(({ type, url, options: options2 = { async: true, defer: true } }) => {
...
var NavContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { segment } = $$props;
  if ($$props.segment === void 0 && $$bindings.segment && segment !== void 0)
    $$bindings.segment(segment);
  $$result.css.add(css$7);
  return `<nav><ul class="${"svelte-1jphw99"}"><li class="${"svelte-1jphw99"}"><a${add_attribute("aria-current", segment === "/" ? "page" : void 0, 0)} class="${escape(null_to_empty(segment === "/" ? "active" : void 0)) + " svelte-1jphw99"}" href="${"."}"><span class="${"svelte-1jphw99"}">Home</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${add_attribute("aria-current", segment === "/about-you" ? "page" : void 0, 0)} class="${escape(null_to_empty(segment === "/about-you" ? "active" : void 0)) + " svelte-1jphw99"}" href="${"/about-you"}"><span class="${"svelte-1jphw99"}">About YOU</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${add_attribute("aria-current", segment === "/music-career" ? "page" : void 0, 0)} class="${escape(null_to_empty(segment === "/music-career" ? "active" : void 0)) + " svelte-1jphw99"}" href="${"/music-career"}"><span class="${"svelte-1jphw99"}">Music Career</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${add_attribute("aria-current", segment === "/discography" ? "page" : void 0, 0)} class="${escape(null_to_empty(segment === "/discography" ? "active" : void 0)) + " svelte-1jphw99"}" href="${"/discography"}"><span class="${"svelte-1jphw99"}">Discography</span></a></li>
		<li class="${"svelte-1jphw99"}"><a${add_attribute("aria-current", segment === "/where-to-buy" ? "page" : void 0, 0)} class="${escape(null_to_empty(segment === "/where-to-buy" ? "active" : void 0)) + " svelte-1jphw99"}" href="${"/where-to-buy"}"><span class="${"svelte-1jphw99"}">Where to Buy</span></a></li></ul></nav>`;
});
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.segment === void 0 && $$bindings.segment && segment !== void 0)
    $$bindings.segment(segment);
  $$unsubscribe_page();
  return `<div class="${"hidden lg:block lg:w-3/5 relative top-20"}">${validate_component(NavContent, "NavContent").$$render($$result, { segment }, {}, {})}</div>
...
var NavMobile = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"navMobile"}" class="${"fixed w-0 h-full z-50 overflow-x-hidden bg-gray-800 bg-opacity-95"}"><div class="${"flex flex-wrap flex-col content-end px-6 my-4"}"><button class="${"flex-1 p-0 text-white text-5xl"}">\xD7</button></div>
    ...
    <div class="${"overlay-content mt-6 px-6"}">${validate_component(NavContent, "NavContent").$$render($$result, { segment }, {}, {})}</div></div>`;
});
...
var Waypoint = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"wrapper " + escape(className) + " " + escape(c) + " svelte-pj5vj2"}"${add_attribute("style", style, 0)}>${visible ? `${slots.default ? slots.default({}) : ``}` : ``}</div>`;
});
var css$5 = {
...
var Image = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Waypoint, "Waypoint").$$render($$result, {
    ...
    default: () => `<div style="${"position: relative; width: 100%;"}" class="${["svelte-uco8jw", loaded ? "loaded" : ""].join(" ").trim()}"><div style="${"position: relative; overflow: hidden;"}"><div style="${"width:100%;padding-bottom:" + escape(ratio) + ";"}"></div>
      ${blurhash ? `<canvas class="${"placeholder svelte-uco8jw"}"${add_attribute("width", blurhashSize.width, 0)}${add_attribute("height", blurhashSize.height, 0)}></canvas>` : `<img class="${[
      "placeholder " + escape(placeholderClass) + " svelte-uco8jw",
      blur ? "blur" : ""
      ...
      <picture><source type="${"image/webp"}"${add_attribute("srcset", srcsetWebp, 0)}${add_attribute("sizes", sizes, 0)}>
        ...
        <img${add_attribute("src", src2, 0)} class="${"main " + escape(c) + " " + escape(className) + " svelte-uco8jw"}"${add_attribute("alt", alt, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)}></picture></div></div>`
  })}`;
});
...
${validate_component(NavMobile, "NavMobile").$$render($$result, { segment }, {}, {})}

<div class="${"font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover"}" style="${"background-image:url(" + escape(bg) + ");"}"><div class="${"max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto py-32 px-6 lg:px-0 lg:my-0"}">${validate_component(Nav, "Nav").$$render($$result, { segment }, {}, {})}

		<div class="${"main-content w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 lg:mx-0 lg:h-4/6 lg:overflow-y-scroll"}"><div class="${"p-4 md:p-6"}"><div class="${"block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-top"}" style="${"background-image: url(" + escape(mainImage) + ")"}"></div>
    ...
    class: "no-underline"
  }, {}, { default: () => `Contact webmaster` })} \u2022 ${validate_component(Link, "Link").$$render($$result, {
    href: "https://github.com/mikachan/forget-me-not",
    class: "no-underline"
  }, {}, { default: () => `View on GitHub` })}</p></div></div></div>

		<div class="${"image-rotation w-full lg:w-2/5 svelte-1pidex7"}"><figure class="${"hidden lg:block svelte-1pidex7"}">${validate_component(Image, "Image").$$render($$result, {
    src: mainImage,
    alt: "You",
...
<p>Welcome to <strong>Forget-me-not</strong>, an <a href="${"site/history"}">English fansite</a> dedicated to the Japanese musician, <strong>You</strong>, best known for playing guitar and violin for ${validate_component(Link, "Link").$$render($$result, { href: "https://gackt.com/" }, {}, { default: () => `Gackt` })} and ${validate_component(Link, "Link").$$render($$result, { href: "http://www.sqf.jp/" }, {}, { default: () => `S.Q.F` })}.</p>

<h2>Latest Site Updates <a href="${"site/updates"}" class="${"text-sm"}">read more\xA0\u2192</a></h2>

<p><strong>18.05.21</strong><br>
	Luscious have announced they&#39;re going to be doing another live performance on June 17th! It&#39;ll be at Club Phase Takadanobaba in Tokyo, and will be streamed on ${validate_component(Link, "Link").$$render($$result, {
    href: "https://twitcasting.tv/chachamaru_yfcz"
  }, {}, { default: () => `TwitCasting` })} again. For full details, see ${validate_component(Link, "Link").$$render($$result, {
...
var Music_career = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
<figure>${validate_component(Image, "Image").$$render($$result, {
    alt: "CAINS:FEEL",
    class: "pb-4 mx-auto",
    src: cainsFeel$1,
    ratio: "45%"
...
<p>Luscious is a Japanese band formed by ${validate_component(Link, "Link").$$render($$result, {
    href: "https://twitter.com/CHACHAMARU_YFCz"
  }, {}, {
    default: () => `Chachamaru (Yukihiro Fujimura)`
  })}, and includes Chacha on vocals and guitar, You on guitar, ${validate_component(Link, "Link").$$render($$result, {
    href: "https://twitter.com/Satos_Cafe_Bar"
  }, {}, { default: () => `Sato` })} (ex. GacktJob, LiSA) on bass and ${validate_component(Link, "Link").$$render($$result, {
    href: "https://twitter.com/DuelJewel_val"
  }, {}, { default: () => `Val` })} (ex. GacktJob, DuelJewel) on drums. They have performed at several events alongside Chacha&#39;s other band, Ded Chaplin.</p>

<p>Chacha posts about Luscious on his Twitter account and often streams on ${validate_component(Link, "Link").$$render($$result, {
    href: "https://twitcasting.tv/chachamaru_yfcz"
  }, {}, { default: () => `TwitCasting` })} with the other band members.</p>`;
});
...
var Birthday_2003 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
<p>The cake that You received is shown below (snagged it off the ${validate_component(Link, "Link").$$render($$result, {
    href: "http://www.allnightnippon.com/gackt"
  }, {}, { default: () => `ANN` })} site), topped with strawberries of course!</p>
...
var Cains_feel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
<figure style="${"width: 140px;"}">${validate_component(Image, "Image").$$render($$result, {
...
<ol class="${"list-decimal list-inside"}"><li>\uFF5Elie\uFF5E [${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/cVe9rssPA84" }, {}, { default: () => `youtube` })}]</li>
	<li>MARINE BLUE no kazeni dakarete (marine blue\u306E\u98A8\u306B\u62B1\u304B\u308C\u3066) [${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/A6CEeoU1KG4" }, {}, { default: () => `youtube` })}]</li>
	<li>etude [${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/cvGPKVu3LPQ" }, {}, { default: () => `youtube` })}] [${validate_component(Link, "Link").$$render($$result, {
    href: "downloads/etude.txt",
    download: "etude lyric translation"
  }, {}, { default: () => `lyric translation` })}]</li></ol>
...
<ol class="${"list-decimal list-inside"}"><li>refrain</li>
	<li>\uFF5Elie\uFF5E [${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/cVe9rssPA84" }, {}, { default: () => `youtube` })}]</li>
	<li>MARINE BLUE no kazeni dakarete (marine blue\u306E\u98A8\u306B\u62B1\u304B\u308C\u3066) [${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/A6CEeoU1KG4" }, {}, { default: () => `youtube` })}]</li>
	<li>etude [${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/cvGPKVu3LPQ" }, {}, { default: () => `youtube` })}] [${validate_component(Link, "Link").$$render($$result, {
    href: "downloads/etude.txt",
    download: "etude lyric translation"
...
<p>Gackt has also described this night in an interview from <em>Vicious 08.1998</em>. Ryuik has scanned and translated ${validate_component(Link, "Link").$$render($$result, {
...
<ul><li>The catalyst for them initially becoming close friends was both of them being dumped by their girlfriends!</li>
	...
	<li>Gackt talked about You a lot on his ${validate_component(Link, "Link").$$render($$result, { href: "http://allnightnippon.com/gackt" }, {}, { default: () => `radio show` })}.</li>
...
<p>Gackt described the cover band he put together in the Malice Mizer fanclub magazine <em>Ma ch\xE9rie</em> (vol. 2&amp;3). He first called ${validate_component(Link, "Link").$$render($$result, {
...
<p>Massive thank you to ${validate_component(Link, "Link").$$render($$result, {
...
var Where_to_buy = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
<ul><li>${validate_component(Link, "Link").$$render($$result, { href: "http://www.yesasia.com/" }, {}, { default: () => `YesAsia` })}</li>
	<li>${validate_component(Link, "Link").$$render($$result, { href: "http://www.cdjapan.co.jp/" }, {}, { default: () => `CD Japan` })}</li>
	<li>${validate_component(Link, "Link").$$render($$result, { href: "http://www.amazon.co.jp/" }, {}, { default: () => `Amazon Japan` })}</li>
	<li>${validate_component(Link, "Link").$$render($$result, { href: "http://www.hmv.co.jp/" }, {}, { default: () => `HMV Japan` })}</li>
	<li>${validate_component(Link, "Link").$$render($$result, { href: "http://buyee.jp/" }, {}, { default: () => `Buyee.jp` })}</li>
	<li>${validate_component(Link, "Link").$$render($$result, { href: "http://www.jlist.com/" }, {}, { default: () => `JList` })}</li></ul>
...
var Discography = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
var Full_discography = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
<h3 id="${"studio-albums"}">Studio Albums</h3>
<div class="${"table-container svelte-14x1pov"}"><div class="${"table-fade svelte-14x1pov"}"${add_attribute("this", albumsFade, 0)}></div>
	<div class="${"table-scroll svelte-14x1pov"}"${add_attribute("this", albumsTable, 0)}><table class="${"svelte-14x1pov"}"><thead><tr><th class="${"svelte-14x1pov"}">Year</th>
...
<h3 id="${"singles"}">Singles</h3>
<div class="${"table-container svelte-14x1pov"}"><div class="${"table-fade svelte-14x1pov"}"${add_attribute("this", singlesFade, 0)}></div>
	<div class="${"table-scroll svelte-14x1pov"}"${add_attribute("this", singlesTable, 0)}><table class="${"svelte-14x1pov"}"><thead><tr><th class="${"svelte-14x1pov"}">Year</th>
					<th class="${"svelte-14x1pov"}">Title</th>
					<th class="${"svelte-14x1pov"}">Artist</th>
					<th class="${"svelte-14x1pov"}">Credits</th></tr></thead>
			<tbody><tr><td class="${"svelte-14x1pov"}">1994</td>
...
<h3 id="${"live-music-dvds"}">Live Music DVDs</h3>
<div class="${"table-container svelte-14x1pov"}"><div class="${"table-fade svelte-14x1pov"}"${add_attribute("this", dvdsFade, 0)}></div>
	<div class="${"table-scroll svelte-14x1pov"}"${add_attribute("this", dvdsTable, 0)}><table class="${"svelte-14x1pov"}"><thead><tr><th class="${"svelte-14x1pov"}">Year</th>
					<th class="${"svelte-14x1pov"}">Title</th>
					<th class="${"svelte-14x1pov"}">Artist</th>
					<th class="${"svelte-14x1pov"}">Credits</th></tr></thead>
...
var Life_short_film = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
<p>Gackt has mentioned in interviews that the concept for the video was inspired by the German film, ${validate_component(Link, "Link").$$render($$result, {
    href: "https://www.imdb.com/title/tt0093191/"
  }, {}, {
    default: () => `<em>Wings of Desire</em>`
  })}, from 1987, which was shot in black and white. This features angels in the mortal world who wear long dark coats, and one angel decides to &#39;fall from grace&#39; after falling in love with a human. There&#39;s an American remake called ${validate_component(Link, "Link").$$render($$result, {
    href: "https://www.imdb.com/title/tt0120632/"
  }, {}, { default: () => `<em>City of Angels</em>` })}.</p>
...
<h3>Download</h3>
<p><em>Soyokaze</em> seems pretty difficult to get hold of these days, so I&#39;ve uploaded <em>Life</em> ${validate_component(Link, "Link").$$render($$result, {
    href: "downloads/life-soyokaze.mp4",
    download: "life soyokaze video"
  }, {}, { default: () => `here for download` })} (~60MB).</p>
...
<p>Translation by <strong>muchuu</strong>, originally on myspace and later found ${validate_component(Link, "Link").$$render($$result, {
...
var Nine_nine_radio = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
var Appearances = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $title, $$unsubscribe_title;
  $$unsubscribe_title = subscribe(title, (value) => $title = value);
...
<ul><li>He played <em>Jun</em> in ${validate_component(Link, "Link").$$render($$result, {
  ...
  })}. There&#39;s two other parts/sections to this video ${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/Z9W-f5qJFGc" }, {}, { default: () => `here` })} and ${validate_component(Link, "Link").$$render($$result, { href: "https://youtu.be/-ogP-Vc2SUA" }, {}, { default: () => `here` })}.)</li></ul>
...
<ul><li>Gackt Dears fan club videos</li>
	...
	<li>Modeling jewelery for ${validate_component(Link, "Link").$$render($$result, { href: "http://h-darts.com" }, {}, { default: () => `h-Darts` })}</li>
...
<p><strong>Stage Name:</strong> You (pronounced &#39;yuu&#39;), aka YOU, \u512A, You Kurosaki, \u{1F916}<br>
	...
	<strong>${validate_component(Link, "Link").$$render($$result, {
    href: "https://www.tofugu.com/japan/japanese-blood-type/"
  }, {}, { default: () => `Blood Type` })}:</strong> A<br>
	<strong>Guitar Model:</strong> ${validate_component(Link, "Link").$$render($$result, {
...
<p>You has always been an avid blogger and used to have his own site at ${validate_component(Link, "Link").$$render($$result, { href: "http://www.you-robots.com" }, {}, { default: () => `You-robots.com` })}. It contained a short discography, a gallery, links, etc. He also had an old ${validate_component(Link, "Link").$$render($$result, {
    href: "http://www.gackt-and-lovers.com/free/youblog/"
  }, {}, { default: () => `Gackt staff blog` })} and an ${validate_component(Link, "Link").$$render($$result, {
    href: "https://www.facebook.com/YOU-161091424051137/"
  }, {}, { default: () => `official Facebook page` })}.</p>

<p>Most recently, he writes in his ${validate_component(Link, "Link").$$render($$result, { href: "https://ameblo.jp/yourobot" }, {}, { default: () => `Ameblo blog` })} and occasionally updates his Twitter account, ${validate_component(Link, "Link").$$render($$result, { href: "https://twitter.com/yourobot0210" }, {}, { default: () => `@yourobot0210` })}.</p>
...
<ul><li>He has lots of different nicknames, including &quot;Grapefruit boy&quot; because of Gackt&#39;s Mizerable ~Unmei~ photobook, old man, &quot;Big Brother You&quot; (You-ni-san), pole (denchu) because he&#39;s tall and quiet. And of course, robot, because of how he moves on stage but also because of how he tends to hide his emotions.</li>
	...
	<li>He read through the whole of ${validate_component(Link, "Link").$$render($$result, {
	...
	<li>On 10th February 2018, he announced that he was going to be a father to a mini YOU. He frequently posts about his son on his ${validate_component(Link, "Link").$$render($$result, { href: "https://ameblo.jp/yourobot" }, {}, { default: () => `blog` })}.</li></ul>`;
});
...
<figure style="${"width: 120px;"}">${validate_component(Image, "Image").$$render($$result, {
    alt: "Bracelet",
    class: "p-2 pt-0",
    align: "right",
    src: bracelet,
...
<p>You has designed a couple of bracelets with Monkey-act-web. All You-related things could be found under the <em>WithMAD</em> section of the site. The last bracelet on the ${validate_component(Link, "Link").$$render($$result, {
    href: "http://www.monkey-act-web.com/you/youpage.html"
  }, {}, { default: () => `this page` })} he designed in 2003.</p>

<figure style="${"width: 100px;"}">${validate_component(Image, "Image").$$render($$result, {
    alt: "Earring",
    class: "p-2 pt-0",
    align: "right",
    src: earring,
...
<p>He&#39;s also designed other pieces of jewelery for <em>h-Darts</em>, including earrings, bracelets and necklaces. His latest design is a bracelet titled &quot;Earth&quot;, which can be seen ${validate_component(Link, "Link").$$render($$result, {
...
<div class="${"todos svelte-1dauu4f"}"><h1>Todos</h1>
	...
	${each(todos, (todo) => `<div class="${["todo svelte-1dauu4f", todo.done ? "done" : ""].join(" ").trim()}"><form action="${"/todos/" + escape(todo.uid) + ".json?_method=patch"}" method="${"post"}"><input type="${"hidden"}" name="${"done"}"${add_attribute("value", todo.done ? "" : "true", 0)} class="${"svelte-1dauu4f"}">
				<button class="${"toggle svelte-1dauu4f"}" aria-label="${"Mark todo as " + escape(todo.done ? "not done" : "done")}"></button></form>

			<form class="${"text svelte-1dauu4f"}" action="${"/todos/" + escape(todo.uid) + ".json?_method=patch"}" method="${"post"}"><input aria-label="${"Edit todo"}" type="${"text"}" name="${"text"}"${add_attribute("value", todo.text, 0)} class="${"svelte-1dauu4f"}">
				<button class="${"save svelte-1dauu4f"}" aria-label="${"Save todo"}"></button></form>

			<form action="${"/todos/" + escape(todo.uid) + ".json?_method=delete"}" method="${"post"}"><button class="${"delete svelte-1dauu4f"}" aria-label="${"Delete todo"}" ${todo.pending_delete ? "disabled" : ""}></button></form>
		</div>`)}
</div>`;
});
...
<p>You can view the site source on ${validate_component(Link, "Link").$$render($$result, {
    href: "https://github.com/mikachan/forget-me-not"
  }, {}, { default: () => `GitHub` })}.</p>

<p><a href="${"site/thanks"}">Thank you</a> to everyone who helped make this site possible over the years.</p>

<p>I&#39;m ${validate_component(Link, "Link").$$render($$result, { href: "https://sekai.co.uk" }, {}, { default: () => `Sarah` })}, your average J-rock/anything-Japanese nerd from the UK.</p>`;
});
...
<p><strong>16.02.21</strong><br>
	Ded Chaplin and Luscious are streaming two live performances on 17th and 18th February, from The Doors in Hatsudai. You can purchase tickets to watch the performances live through ${validate_component(Link, "Link").$$render($$result, {
    href: "https://twitcasting.tv/chachamaru_yfcz"
  }, {}, { default: () => `TwitCasting` })}, which also gives you access to watch the stream recording up to 2 weeks from the original broadcast. See ${validate_component(Link, "Link").$$render($$result, {
